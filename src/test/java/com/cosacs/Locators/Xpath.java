...
public class Xpath {
	...
	public static class ProductDetails
	{
		...
		public static String Warrenty="//input[@ng-model='vm.product.warrantable']";
		...
		public static String ScrollAWC="//div//label[@for='averageWeightedCost']]";
		...
		public static String EDP="(//table[@class='ui-datepicker-calendar']//a)[2]";
	...
	public static class toastMassage
{
 public static String Message_catch="//div[@id='growlcontainer']";
	...
	public static class CreatePurchaseOrder {
		...
		//10.7
		public static String EditLable="//button[contains(.,'Edit Labels ')]";
		public static String Qtytoprint="//input[@name='printQuantity']";
		public static String PrintLables="//button[contains(.,'Print Labels ')]";
		public static String Cancel="(//button[contains(.,'Cancel ')])[1]";
	}
...
/*	public static class RegularStock
	...
	public static class SearchDeliverySchedules
	{
		...
		public static String ShipmentID="//a[@class='Booking-Id']";
	}
	...
	public static class TechnicanDairy
	{
		...
		public static String HolidayApprove="(//td[@class='fixed holidayApproved click'])[9]";
	...
	{
		public static String Merchandising = "//li/a[contains(text(),'Merchandising')]";
		public static String MerchandisingSearch="(//a[contains(.,'Merchandising')]/..//a)[20]";
		public static String Create = "//li[@class='dropdown-submenu']//a[contains(text(),'Create')]";
		public static String SearchStockCount = "(//ul//li[contains(.,'Stock Counts')])[3]";
		
		public static String Stokcount="(//li//a[contains(.,'Stock Count')])[1]";
		public static String Location="(//div[@class='list-container ng-scope']//div[@class='list-arrow'])[2]";
		public static String LocationSearch="//div[@class='list-search ng-scope']//input";
		public static String LocationList="//div[@class='list-item-container ng-scope']//div[@class='list-item ng-scope ng-binding']";
		
		public static String Date="//div[@class='col-md-8']//input[@name='countDate']";
		
		
		public static String Division="(//list[@name='hierarchy']//div[@class='list-container ng-scope'])[1]//div[@class='list-arrow']";
		public static String DivisionSearch="//div[@class='list-options ng-scope']//input";
		public static String DivisionList="//div[@class='list-item ng-scope ng-binding']";
		
		public static String Department="(//list[@name='hierarchy']//div[@class='list-container ng-scope'])[3]//div[@class='list-arrow']";
		public static String DepartmentSearch="//div[@class='list-search ng-scope']//input";
		public static String DepartmentList="//div[@class='list-item ng-scope ng-binding']";
		
		public static String Class="(//list[@name='hierarchy']//div[@class='list-container ng-scope'])[5]//div[@class='list-arrow']";
		public static String ClassSearch="//div[@class='list-search ng-scope']//input";
		public static String ClassList="//div[@class='list-item ng-scope ng-binding']";
		
		public static String StockLocation="//list[@name='location']//div[@class='list-arrow']";
		public static String StockLocationSearch="//div[@class='list-search ng-scope']//input";
		public static String StockLocationList="//div[@class='list-item ng-scope ng-binding']";
		
		
		public static String schedule="//button[contains(.,'Schedule')]";
		public static String ScheduleFrom="//input[@name='minScheduledDate']";
		public static String ScheduleTo="//input[@name='maxScheduledDate']";
		
		public static String Search="//button[contains(.,'Search')]";
		
		public static String StockCountID="//td[@class='text-right']//a";
		public static String Start="//button[contains(.,'Start')]";
...
/*		public static String FindProductDropDown = "//a[@class='select2-choice select2-default']//div";
		public static String FindProductSearch = "//div[@class='select2-search']//input[@type='text']";
		public static String FindProductList = "(//ul[@class='select2-results']//div[@class='select2-result-label'])[1]";*/
		
		public static String PrintStockcountsheet="//button[@ng-click='print()']";
	...
	public static class CreateStockCount {
		...
		public static String DivisionDropDown = "//span[contains(text(),'Select a Fascia')]";
		public static String DivisionSearch="(//input[@class='ng-pristine ng-valid'])[1]";
		public static String DivisionSele="(//div[@class='list-item-container ng-scope']//div)[1]";
		public static String DivisionDropDown1 = "(//div[@class='list-container ng-scope'])[2]//div[@class='list-arrow']";
		public static String DepartmentDropDown = "(//div[@class='list-container ng-scope'])[4]//div[@class='list-arrow']";
		public static String ClassDropDown = "(//div[@class='list-container ng-scope'])[6]//div[@class='list-arrow']";
		public static String Schedule = "//button[contains(.,'Schedule')]";
		public static String quaterly="//input[@value='Quarterly']";
		// Stock Count validation
		public static String Search1 = "(//a[contains(.,'Search')])[11]";
		public static String SearchStockCount = "//ul//li[.='Stock Counts']";
		...
		public static String ScheduledFrom = "(//div[@class='form-group'])[4]//input[@class='form-control ng-pristine ng-valid']";
		public static String Search2 = "//button[.='Search']";
		public static String StockCountLabel="//h2[@id='page-heading']";
		public static String StockCountID = "(//a[@class='ng-binding'])[1]";
		public static String stockStatus="(//span[@class='list-value ng-binding'])[2]";
		public static String stockStatusSearch="//input[@class='ng-pristine ng-valid']";
		public static String stockStatusSele="//div[@class='list-item-container ng-scope']";
		public static String Status = "//tr[@ng-repeat='item in orderItemsResult']//td[@class='ng-binding']";
		public static String StartButton = "//button[contains(.,'Start')]";
		public static String CollectionNotes = "(//input[@type='checkbox'])[1]";
		public static String DeliveryNotes = "(//input[@type='checkbox'])[2]";
		...
		public static String FindProductDropDown = "//a[@class='select2-choice select2-default']//div";
		public static String FindProductSearch = "//div[@class='select2-search']//input[@type='text']";
		public static String Product="//ul[@class='select2-results']";
		public static String FindProductList = "//ul[@class='select2-results']//div[@class='select2-result-label']";
		public static String StockCount1 = "//table//tr[@ng-form='productForm']//td[@class='quantity']//input[@name='count']";
		public static String Comments = "//tr[@class='ng-scope ng-valid ng-dirty']//input[@class='form-control ng-pristine ng-valid']";
		public static String SaveAll = "//button[contains(.,'Save All')]";
...
//		public static String StockCountMin = "(//div//input[@class='form-control ng-pristine ng-valid ng-valid-required'])[1]";
//		public static String Home = "//nav[@class='navbar navbar-inverse navbar-fixed-top']//a[@id='home']";
//		public static String Home1 = "//nav[@class='navbar navbar-inverse navbar-fixed-top']//a[@id='home']";
//		public static String SelectStatus = "//span[contains(text(),'Select a Status')]";
//		public static String SearchStatus = "//input[@class='ng-pristine ng-valid']";
//		public static String VerifySelectStatus = "(//div[@class='list-item ng-scope ng-binding'])[1]";

	}

	public static class Address
	{
		public static String Administration="//li//a[contains(.,'Administration')]";
		public static String Addressmaster="//li//a[contains(.,'Address Master')]";
		public static String Add="//td//a[@class='glyphicons glyph-btn action-new plus']";
		public static String Region="//div//input[@name='Region']";
		public static String Village="//div//input[@name='Village']";
		public static String Zipcode="//div//input[@name='ZipCode']";
		public static String Save="//a[@class='glyphicons glyph-btn action-update floppy_disk']";
